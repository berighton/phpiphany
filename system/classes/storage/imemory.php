...
interface imemory {
	 ...
	 * @param bool $serialize	- serialize value or not. This would be false when you use redis, memcache or APC for sessions which serialize data anyways
	 * @return bool
	 */
	...
	/**
	 * Increment value of the keycache_host
	 * @param string $key
	 ...
	 * Time of waiting is defined in max_wait_unlock constant of memory class.
	 * @param string $key
	 * @param $auto_unlocker
	 * @return boolean
	 */
